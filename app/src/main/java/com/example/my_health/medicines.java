...
public class medicines extends AppCompatActivity {
    ...
    private String[][] packages={{"Xalatan Eye Drop 2.5ml ","500"},
            {"Cosopt Eye Drop 5ml ","600"},
            {"Acefyl 125ml Syp " , "700"},
            {"Acenac Sr Tablets 200mg 30's " , "800"},
            {"Augmentin Suspension 156.25mg 90ml " , "900"},
            {"Babynol Cough Syrup 60ml " , "1000"},
